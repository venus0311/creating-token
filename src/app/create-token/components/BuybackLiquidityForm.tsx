...
const BuybackLiquidityForm: React.FC = () => {
    ...
    <div className="pt-6 sm:rounded-xl sm:border sm:border-background-300 sm:p-6 space-y-6">
      <div className="space-y-4">
        <div className="space-y-2">
          <h3 className="block text-sm/[1.5] font-medium text-text-500">Buyback & Liquidity</h3>
          <p className="block text-text-300 text-sm/[1.5]">A fee is collected in your token and used to buyback tokens and add liquidity.</p>
        </div>
        <div className="space-y-2">
          <RadioGroup
            options={[
        ...
        <div className="space-y-2">
          <label data-optional={false} className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" htmlFor="buyback-tax-percentage">
            Tax Percentage
          </label>
...
export default BuybackLiquidityForm;
